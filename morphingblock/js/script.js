...
// 連接合約
const rpcHost = 'http://172.18.9.65:8545/';
const {
	ethers
} = window;
...
$('.btn').click(function() {
	...
	walletAddr = wallet;
	const getUrl = 'http://172.18.9.65:18099/req_reward?macAddr=' + macAddr + '&walletAddr=' + walletAddr + '&inAmount=' + l_inAmount + '&tokenType=1&txID=' + l_txCounter;
	console.log(getUrl);
	fetch(getUrl)
